...
public class Generator {
	...
	public void generator() {
		...
		String srcPath = "E:\\workspace\\scaffold\\spring-boot-spring-security-mybatisplus\\src\\main\\java";//项目源码绝对路径
		...
		gc.setEnableCache(true);// 生成XML二级缓存标签，类需要在mapper.xml.vm里面修改
		...
		pc.setModuleName("mtoliv");//模块名，该模块是下列所有包名的父包
